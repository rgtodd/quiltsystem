...
{
    public class MFulfillment_UpdateReturnRequest
    {
        ...
        public IList<MFulfillment_UpdateReturnRequestItem> UpdateReturnRequestItems { get; set; }
    }

    public class MFulfillment_UpdateReturnRequestItem
    {
