...
using RichTodd.QuiltSystem.Web.Mvc.TagHelpers;

namespace RichTodd.QuiltSystem.WebAdmin
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //
            _ = services.AddTransient<ITagHelperComponent, SecuredDivTagHelperComponent>();
        }
