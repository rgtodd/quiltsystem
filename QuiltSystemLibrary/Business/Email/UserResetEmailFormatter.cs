...
{
    public class UserResetEmailFormatter : EmailFormatter
    {
        private readonly string m_link;

        public UserResetEmailFormatter(string link)
        {
        ...
        public override string GetHtml()
        {
            ...
            html = html.Replace(TemplateVariables.TemplateBody, Resources.EmailUserResetHtmlTemplate);
        ...
        public override string GetText()
        {
            ...
            text = text.Replace(TemplateVariables.TemplateBody, Resources.EmailUserResetTextTemplate);
        ...
        {
            return Constants.WebsiteName + " Password Reset";
        }
    }
}