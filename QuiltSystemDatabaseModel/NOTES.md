...
Scaffold-DbContext 'Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=QuiltCoreModel' Microsoft.EntityFrameworkCore.SqlServer -OutputDir Database\Model -Context QuiltContext -Force -DataAnnotation
