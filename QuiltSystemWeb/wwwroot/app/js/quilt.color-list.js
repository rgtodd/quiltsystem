...
QUILT.colorList = {
    catalog: null, // XDesign_FabricStyleCatalog
    selectedSku: null,
    selectedDiv: null,
    callback: null,
    callbackData: null
...
function _colorList_retrieveCatalogAsync(sku) {
    $.ajax({
        ...
        dataType: "json"
    }).done(function ( /* XDesign_FabricStyleCatalog */ response) { _colorList_onRetrieveCatalogComplete(response, sku); });
}
...
function _colorList_onRetrieveCatalogComplete( /* XDesign_FabricStyleCatalog */ response, sku) {
